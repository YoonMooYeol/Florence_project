# Generated by Django 4.2 on 2025-03-11 09:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('conversations', models.ManyToManyField(related_name='event_summaries', to='llm.llmconversation', verbose_name='관련 대화')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversation_summaries', to='calendars.event', verbose_name='관련 일정')),
            ],
            options={
