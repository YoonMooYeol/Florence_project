...
저희 서비스인 누리달은 AI 기반의 지능형 산전 관리 도우미로, OpenAI Agent를 활용하여 AI 기능을 제공합니다. 
이를 통해 임산부들에게 맞춤형 산전 관리 서비스를 제공하며, 효율적인 건강 관리와 정보 제공을 지원합니다.
...
- **자동화 도구** : 주기적인 작업 수행 및 업무 자동화
- **소켓** : 실시간 데이터 전송 및 이벤트 기반 처리
- **websockets** : 실시간 통신을 통한 사용자 상호작용 처리
