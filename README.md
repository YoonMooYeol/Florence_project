...
| 최정은 | 팀원| **백엔드, SA문서 관리**/ **기술 구현 목록**: 이메일 인증 이용한 ID/PW 찾기, 아이디 전화번호 중복확인, 비밀번호 재설정, 회원 탈퇴 기능, 팔로우/팔로잉 및 검색 기능, 프로필 사진 및 태교일기 사진 CRUD 기능, | [🌙 https://github.com/ouxrlo]    |
